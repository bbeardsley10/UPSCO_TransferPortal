...
INSERT INTO "new_Transfer" ("createdAt", "enteredIntoSystem", "enteredIntoSystemAt", "fromUserId", "id", "notes", "pdfFileName", "pdfPath", "receivedAtDestination", "receivedAtDestinationAt", "status", "statusUpdatedAt", "toUserId", "updatedAt") SELECT "createdAt", "enteredIntoSystem", "enteredIntoSystemAt", "fromUserId", "id", "notes", "pdfFileName", "pdfPath", "receivedAtDestination", "receivedAtDestinationAt", "status", "statusUpdatedAt", "toUserId", "updatedAt" FROM "Transfer";
DROP TABLE "Transfer";
